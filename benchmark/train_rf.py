...
MODEL_PATH = MODEL_DIR / "rf_model_cv.pkl"
...
def main():
    ...
    rf = RandomForestClassifier(
        random_state=42,
        class_weight="balanced",  # RF's own built-in balancing, in addition
                                   # to the sample_weight passed at fit time
        n_jobs=-1,
    )
    ...
    save_text(OUTPUT_DIR / "rf_final_test_report.txt", "\n".join(report_lines))
    ...
    save_text(OUTPUT_DIR / "rf_final_test_misclassified.txt", "\n".join(mis_lines))
